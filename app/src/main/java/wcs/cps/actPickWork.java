...
public class actPickWork extends Activity 
{
	...
	private TextView txt_gzjb=null;
	...
	private TextView[] tv_zyFht=null;
	...
	private void mSetSysData()
	{
		...
		txt_gzjb=(TextView)findViewById(R.id.txt_gzjb);
    	...
    	tv_zyFht=new TextView[4];
    	tv_zyFht[0]=(TextView)findViewById(R.id.tv_zyFht01);
    	tv_zyFht[1]=(TextView)findViewById(R.id.tv_zyFht02);
    	tv_zyFht[2]=(TextView)findViewById(R.id.tv_zyFht03);
    	tv_zyFht[3]=(TextView)findViewById(R.id.tv_zyFht04);
		...
		try
		{
			...
			if (sFunNo.compareTo(clsMyPublic.g_SktParamPickTask)==0)
			{
				...
				{	
					...
					_PickTask._sGzjb=clsMyPublic.GetStrInOfStr(sReceData,26);
			...
			else if (sFunNo.compareTo(clsMyPublic.g_sktParamFpdGroup)==0)
			{
				...
				else
				{
					...
					m_BoxTask[iZcIndex]._sFhtNo=clsMyPublic.GetStrInOfStr(sReceData, 8);
					m_iSumBoxCount++;
					...
					tv_zyFht[iZcIndex].setText(m_BoxTask[iZcIndex]._sFhtNo);
    ...
    private void mViewJhData(View v)
    {
    	...
    	if (_PickTask._sGzjb.length()!=0)
		{
			txt_gzjb.setText(_PickTask._sGzjb);
			txt_gzjb.setBackgroundResource(R.drawable.clrcurboxback);
		}
		else
		{
			txt_gzjb.setText(null);
			txt_gzjb.setBackgroundColor(0);
		}
