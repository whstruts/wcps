...
public class clsMyPublic
{
	...
	public static final int LyTypeUiMess=4;  //蓝牙消息
	...
	public static  String g_WorkName=""; //员工名称
    ...
    public static final String  g_sktParamDpQr="PSB0021";      //货位动盘
	...
	public static final String g_SqWorkType_Zjjh="3";     //追加拣货
	...
	public static final String g_SqWorkType_Gjtc="10";     //购进退出	
